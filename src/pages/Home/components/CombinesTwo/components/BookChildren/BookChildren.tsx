...
export default function BookChildren() {
    ...
    return (
        <div>
            <TitleModule icon={faEye} width='w-[160px]' heading={titleModule.bookChildren.heading} />
            ...
            {isFetching && (
                <div className='grid grid-cols-6 gap-2 animate-none'>
                    {[0, 0, 0, 0, 0, 0].map((_, index) => (
                        <div className='col-span-2' key={index}>
                            <div className='flex items-center justify-center w-full h-[338px] border border-gray-200 rounded-lg bg-gray-50 dark:bg-gray-800 dark:border-gray-700 '>
                                <div role='status'>
                                    <svg
                                        aria-hidden='true'
